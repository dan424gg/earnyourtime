//
//  BadActivityTotalTimeReport.swift
...
extension DeviceActivityReport.Context {
    ...
    // report.
    static let badActivity = Self("BadActivity")
}


struct BadActivityTotalTimeReport: DeviceActivityReportScene {
    // Define which context your scene will represent.
    let context: DeviceActivityReport.Context = .badActivity
    
    // Define the custom configuration and the resulting view for this report.
    let content: (String) -> BadActivityTotalTimeView
